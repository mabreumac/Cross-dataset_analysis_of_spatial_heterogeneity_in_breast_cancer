...
#SBATCH -n 8
#SBATCH -t 4:00:00
#SBATCH -J ST_V10F03-034_B 
#SBATCH -o result_%ST_V10F03-034_B.out
#SBATCH -e result_%ST_V10F03-034_B.err
...
FASTQ=/mnt/storage/Documents/Academia/Daub_Lab/ST_BRCA_Project/Scripts/files/spacerangerTest/V10F03-034/V10F03-034_B/raw_data
SAMPLEID=V10F03-034_B
JPEG=/mnt/storage/Documents/Academia/Daub_Lab/ST_BRCA_Project/Scripts/files/spacerangerTest/V10F03-034/V10F03-034_B/images/img.jpg
SLIDE=V10F03-034
AREA=B1
