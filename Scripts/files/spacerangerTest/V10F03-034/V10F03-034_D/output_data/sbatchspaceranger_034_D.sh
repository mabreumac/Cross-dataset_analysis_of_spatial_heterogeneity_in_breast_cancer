...
#SBATCH -n 8
#SBATCH -t 4:00:00
#SBATCH -J ST_V10F03-034_D 
#SBATCH -o result_%ST_V10F03-034_D.out
#SBATCH -e result_%ST_V10F03-034_D.err
...
FASTQ=/mnt/storage/Documents/Academia/Daub_Lab/ST_BRCA_Project/Scripts/files/spacerangerTest/V10F03-034/V10F03-034_D/raw_data
SAMPLEID=V10F03-034_D
JPEG=/mnt/storage/Documents/Academia/Daub_Lab/ST_BRCA_Project/Scripts/files/spacerangerTest/V10F03-034/V10F03-034_D/images/img.jpg
SLIDE=V10F03-034
AREA=D1
